...
describe("bounded numeric expression parsing", () => {
  ...
  it.each([
    ...
    ["a compact Eastern Pwo Karen zero", "I divided by𑛚, so x = 9"],
  ...
  it.each([
    ...
    ["a compact Eastern Pwo Karen nonzero", "I divided by𑛛, so x = 11 - 2"],
    ...
    ["ordinary prose containing zero", "I divided by 2 to get 10, then subtracted 1, so x = 11 - 2"],
